...
public class FileCreationRunner {
	...
	public void createDirectory() {
		...
		path = Paths.get("./resources/UserFiles");
		/*Developer comment: for practical result go to your prj workspace and check in the samepath if not shown  in eclipse IDE*/
		try {
